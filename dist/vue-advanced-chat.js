...
var Roomvue_type_template_id_2cf528fc_staticRenderFns = []


// CONCATENATED MODULE: ./src/ChatWindow/Room/Room.vue?vue&type=template&id=2cf528fc&
...
/* harmony default export */ var Roomvue_type_script_lang_js_ = ({
  ...
  mounted: function mounted() {
    ...
    this.$nextTick(function () {
      _this3.$refs['roomTextarea'].addEventListener('click', function () {
      ...
      _this3.$refs['roomTextarea'].addEventListener('blur', function () {
...
var Room_component = normalizeComponent(
  ...
  Roomvue_type_template_id_2cf528fc_render,
  Roomvue_type_template_id_2cf528fc_staticRenderFns,
  false,
  null,
  null,
  null
